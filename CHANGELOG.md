...
- Allow ignoring `excluded_exceptions` when manually capturing exceptions [#2007](https://github.com/getsentry/sentry-ruby/pull/2007)
  ...
  ```rb
  # assume IgnoredException is included in config.excluded_exception
  Sentry.capture_exception(IgnoredException) # won't be sent to Sentry
  Sentry.capture_exception(IgnoredException, hint: { ignore_exclusions: true }) # will be sent to Sentry
  ```
